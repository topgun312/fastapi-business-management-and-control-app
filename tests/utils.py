...
def list_prepare(response: Response, exclude: Sequence[str] | None = None) -> list[dict]:
...
def list_prepare_payload(response: Response, exclude: Sequence[str] | None = None) -> list[dict]:
...
def prepare_without_payload(response: Response, exclude: Sequence[str] | None = None) -> dict:
  """Get without payload."""
  payl = response.json()
  payload = get_payload(payl, exclude)
  return payload
