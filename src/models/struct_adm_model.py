...
class StructAdmModel(BaseModel):
    ...
    company_id: Mapped[uuid4] = mapped_column(ForeignKey('company_table.id', ondelete='CASCADE'), nullable=False)
    head_user_id: Mapped[uuid4] = mapped_column(ForeignKey('user_table.id', ondelete='SET NULL'), nullable=True)
