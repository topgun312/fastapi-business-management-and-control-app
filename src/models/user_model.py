...
if TYPE_CHECKING:
    from src.models import AccountModel, MemberModel, SecretModel, StructAdmModel, TaskModel, UserPositionModel
...
class User(BaseModel):
    ...
    struct_adm: Mapped['StructAdmModel'] = relationship(
        back_populates='head_user', passive_deletes=True,
    )
