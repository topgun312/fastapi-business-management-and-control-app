...
async def get_current_active_auth_user(user: UserAuthSchema = Depends(get_current_auth_user)) -> UserAuthSchema:
...
async def get_current_admin_auth_user(user: UserAuthSchema = Depends(get_current_auth_user)) -> UserAuthSchema:
...
async def validate_auth_user(username: str = Form(), password: str = Form(), service: JWTAuthService = Depends(JWTAuthService)):
